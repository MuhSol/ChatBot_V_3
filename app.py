...
def predict_response(msg):
    ...
    if (prediction[0] == 0):
        return " well You do not have diabetes, we can provide you with information to  you healthy"
    else:
        return "Unfortunately, you have diabetes. We can give you some advice if you want"
